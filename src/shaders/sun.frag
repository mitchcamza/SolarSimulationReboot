...
/**
* @brief Fractal Brownian Motion
* @param p Position
* @author Yuri Artiukh, Mitch Campbell
* Inspired by Yuri Artiukh
* https://www.youtube.com/watch?v=3krH52AhPqk&list=TLPQMDYwODIwMjTE4AJqdMZT_Q&index=10
*/
float fbm(vec4 p)
{
  float sum = 0.0;
...
/**
* @brief Contrast function
* @author Mitch Campbell
* @param val Value
* @param factor Factor
* @return Contrast value
*/
float contrast(float val, float factor)
{
...
void main() 
{
    ...
    combinedNoise = contrast(combinedNoise, 1.15);

    // Colour
    vec3 color1 = vec3(1.0, 0.42, 0.0);
